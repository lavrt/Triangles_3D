...
PROGRAM_PATH = os.path.join(SCRIPT_DIR, "..", "..", "..", "build", "tests", "run_e2e_reference")
...
for dat_file in glob.glob(os.path.join(TEST_DATA_DIR, "*.dat")):
    ...
    command = [PROGRAM_PATH, "--input", os.path.basename(dat_file), "--output", os.path.basename(output_file)]
