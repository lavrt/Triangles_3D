...
bool Segment::IntersectInPlane(const std::pair<size_t, size_t>& plane, const std::span<Segment>& edges1, const std::span<Segment>& edges2) {
...
bool Segment::IntersectInPlane(const std::pair<size_t, size_t>& plane, const Segment& s1, const Segment& s2) {
...
double Segment::Direction(const std::pair<size_t, size_t>& plane, const Point& p) const {
...
bool Segment::OnSegment(const std::pair<size_t, size_t>& plane, const Point& p) const {
